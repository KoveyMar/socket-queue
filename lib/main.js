...
var socketQueue = function () {
  ...
  _createClass(socketQueue, [{
    ...
    value: function rebuildSocket() {
      ...
      var FN = function FN(num) {
        return new Promise(function (resolve, reject) {
          timer = setTimeout(function () {
            _log["default"].Info("WebSocket state ".concat(_this2.WSState, ", in ").concat(num, " connect WebSocket"));
      ...
      this.resolveConnect && this.resolveConnectTime > 0 && FN(this.resolveConnectTime).then(function (res) {
        clearTimeout(timer);
      });
