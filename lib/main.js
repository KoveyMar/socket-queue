...
var socketQueue = /*#__PURE__*/function () {
  ...
  _createClass(socketQueue, [{
    ...
    value: function stateDispatch($value) {
      ...
      switch ($value) {
        case 0:
          _log["default"].alert(' WebSocket is connecting... '); // this.beforeOpen();


          break;

        case 1:
          _log["default"].alert(' WebSocket is connect! '); // this.open();


          break;

        case 2:
          _log["default"].alert(' WebSocket will close... '); // this.beforeClosed();


          break;

        case 3:
          _log["default"].warn(' WebSocket is closed! '); // this.closed();
    ...
    value: function openSocket() {
      ...
      this.socket.onmessage = function (e) {
        ...
        _this.ntf.showNotification(options);
      };
    }
    /**
     * @description 断线重连
