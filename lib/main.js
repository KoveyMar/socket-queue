  ...
  _createClass(socketQueue, [{
    ...
    value: function init() {
      ...
      if ((0, _utils.isObject)(socket)) {
        ...
        this.open = (0, _utils.isFun)(socket.open) ? socket.open : new Function();
        this.closed = (0, _utils.isFun)(socket.closed) ? socket.closed : new Function();
        this.error = (0, _utils.isFun)(socket.error) ? socket.error : new Function();
      }

      (0, _utils.isString)(socket) && (this.url = socket);
      !(0, _utils.isString)(this.protocol) && _log["default"].Error("TypeError: WebSocket protocol can't resolve, protocol must be string, but got ".concat(_typeof((0, _utils.getType)(this.protocol))));
