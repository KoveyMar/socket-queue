...
var SocketQueue = function () {
  ...
  _createClass(SocketQueue, [{
    ...
    value: function send(data) {
      return this.WSState === 1 ? (this.socket.send(data), Promise.resolve()) : Promise.reject();
    }
  }, {
    key: "getData",
    ...
    value: function initWSocket() {
      ...
      try {
        ...
        this.socket.onclose = function (evt) {
          ...
          _this.isClose && (_this.rebuildSocket(evt.type), _this.WSState = evt.target.readyState);
