  ...
  _createClass(notification, [{
    ...
    value: function init(notice) {
      ...
      if ((0, _utils.isObject)(notice)) {
        ...
        this.done = (0, _utils.isFun)(notice.done) ? notice.done : new Function();
        this.fail = (0, _utils.isFun)(notice.fail) ? notice.fail : new Function();
        this.close = (0, _utils.isFun)(notice.OnClose) ? notice.OnClose : new Function();
        this.show = (0, _utils.isFun)(notice.OnShow) ? notice.OnShow : new Function();
        this.click = (0, _utils.isFun)(notice.OnClick) ? notice.OnClick : new Function();
        this.error = (0, _utils.isFun)(notice.OnError) ? notice.OnError : new Function();
      }
