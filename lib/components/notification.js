...
var notification = /*#__PURE__*/function () {
  ...
  _createClass(notification, [{
    ...
    key: "closeEvt",
    value: function closeEvt() {// notification.ntf.onclose = () => {
      // 	notification.close();
      // }
    }
  }, {
    key: "errorEvt",
    value: function errorEvt() {// notification.ntf.onerror = (e) => {
      // 	notification.error(e);
      // }
    }
  }, {
    key: "clickEvt",
    value: function clickEvt() {// notification.ntf.onclick = (e) => {
      // 	e.preventDefault();
      // 	notification.click();
      // } 
    }
    ...
    value: function showEvt() {
      notification.ntf.onshow = function () {
        // notification.show();
        notification.autoClose && setTimeout(function () {
